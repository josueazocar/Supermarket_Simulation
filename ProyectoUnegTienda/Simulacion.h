...
namespace ProyectoUnegTienda {
	...
	private: System::ComponentModel::IContainer^ components;
		   ...
		   void InitializeComponent(void)
		   {
			   ...
			   this->panel1->Location = System::Drawing::Point(0, 575);
			   this->panel1->Name = L"panel1";
			   this->panel1->Size = System::Drawing::Size(1075, 170);
	...
	private: System::Void CerrarPrograma(System::Object^ sender, System::EventArgs^ e) {
		...
		this->Close();
		// Validacion por si se acaban todos los productos, se notifica al usuario
		if (stock_se_termino()) {
			MessageBox::Show("No hay productos para vender", "Información", MessageBoxButtons::OK, MessageBoxIcon::Information);
		}

		// Funciones que involucran la creacion de los reportes
		Producto_masvendido();
		Mostrar_reportes();
		EliminarReportesFacturas(); // se eliminan las facturas guardadas despues de ser mostradas en pantalla
