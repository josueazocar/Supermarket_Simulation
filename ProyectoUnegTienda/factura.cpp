...
namespace Factura_Reportes {
	...
	{
	public:
		VisorFacturasForm(List<String^>^ archivos, int total_ventas, String^ nombre_producto, int NumeroClientesRecibidos, int NumeroClientesAtendidos,
			int NumeroClientesDevueltos) {
